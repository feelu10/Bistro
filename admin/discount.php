    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Discount                    <a href="#" class="btn btn-primary btn-sm ms-3 add-new-discount"  data-bs-toggle="modal" data-bs-target="#add-discount-modal">
                        Add New                    </a>
                </h4>
            </div>
        </div>
            ...
            <div class="card animate__animated animate__bounceInRight">
                <div class="card-body">
                    <div class="alert alert-info bg-info text-white border-0">
                        <p>Enter discount - promo code, for time range and total price will reduce with `discount` values!</p>
                    </div>
                    <div class="row">
                        <form name="table-frm" id="table-frm-id" method="post" action="#action=deleteSelected">
                            <div class="table-responsive">
    <table id="discount-datatable-id" class="table dt-responsive nowrap w-100" cellpadding="0" cellspacing="0" >
        ...
        <tbody>
                                <tr>
                        <td>asdas</td>
                        <td>01.05.2023 - 19.05.2023</td>
                        <td>123</td>
                        <td>₱ 100</td>
                        <td>price</td>
                        <td>3</td>
                        <td>
                            <a class="action-icon icon-edit" href="javascript:" data-id="1">
                                <i class="mdi mdi-lead-pencil"></i>
                            </a>
                            <a class="action-icon icon-delete" data-id="1" href="javascript:">
...
<div class="modal fade" id="edit-discount-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="edit-dicount-container-id">
            </div>
            <div class="modal-footer">
                <a href="javascript:" id="edit-discount-btn-id" class="btn btn-success">Save</a>
...
<div class="modal fade" id="add-discount-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="add_discount" id="add_discount_id" method="post" action=""> 
                    <div class="mb-3">
                        ...
                        <input data-rule-required="true" type="text" class="form-control" id="title" name="title">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input data-rule-required="true" class="form-control" type="number" name="count">
                        </div>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                <a href="javascript:" id="add-discount-btn-id" class="btn btn-success">Save</a>
...
<div class="modal fade" id="dialogDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Discount delete</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <p>Discount will be deleted</p>
            </div>
            <div class="modal-footer">
