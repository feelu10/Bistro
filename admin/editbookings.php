...
<div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Booking Change Status
                </h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card animate__animated animate__bounceInRight">
                <div class="card-body">
                        ...
                        <form  method="post" action="controller/edit-bookings.php">
                        <?php 
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    <div class="row justify-content-center text-center">
                                        ...
                                        <label for="">Name</label>
                                            <input type="text" class="form-control text-center" value="<?=ucwords($row['book_name'])?>" disabled>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center text-center">
                                        <div class="col-sm-3 m-2">
                                        <label for="">Date Time</label>
                                            <input type="text" class="form-control text-center" value="<?=ucwords($row['book_date'].' / '.convertTo12HrFormat($row['book_time']))?>" disabled>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center text-center">
                                        <div class="col-sm-3 m-2">
                                        <label for="">Booked</label>
                                            <input type="text" class="form-control text-center" value="<?=ucwords($row['book_available'])?>" disabled>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center text-center">
                                        <div class="col-sm-3 m-2">
