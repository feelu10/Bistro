    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Amenities                 <a href="#" class="btn btn-primary btn-sm ms-3">Add New</a>
                </h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card animate__animated animate__bounceInRight">
                <div class="card-body">
                    <div class="row">
                        <form name="table-frm" id="table-frm-id" method="post" action="#&action=deleteSelected">
                            <div class="table-responsive">
    <table id="gz-data-table-id" class="table dt-responsive nowrap w-100" cellpadding="0" cellspacing="0" >
        ...
        <tbody>
                                <tr>
                        <td>
                            <input class="simple mark" type="checkbox" name="mark[]"  id="mark-1" value="1"/>
                        </td>
                        <td>
                                                            <span class="table-avatar">
                                    <img class="me-3 rounded-circle" src='#' >
                                </span>
                                                        </td>
                        <td><strong>Tables</strong></td>
                        <td>
                            <a class="action-icon" href="#&amp;action=index&amp;id=1">
                                <i class="mdi mdi-cash-multiple"></i>
                            </a>
                            <a class="action-icon" href="#s&amp;action=index&amp;id=1">
                                <i class="mdi mdi-cog-outline"></i>
                            </a>
                            <a class="action-icon icon-edit" href="#r&amp;action=edit&amp;id=1" data-id="1" >
                                <i class="mdi mdi-lead-pencil"></i>
                            </a>
                            <a class="action-icon icon-delete" rev="1" href="javascript:" >
                        ...
                        <td><strong>Private Room</strong></td>
                        <td>
                            <a class="action-icon" href="#id=2">
                                <i class="mdi mdi-cash-multiple"></i>
                            </a>
                            <a class="action-icon" href="#id=2">
                                <i class="mdi mdi-cog-outline"></i>
                            </a>
                            <a class="action-icon icon-edit" href="#id=2" data-id="2" >
                                <i class="mdi mdi-lead-pencil"></i>
                            </a>
                            <a class="action-icon icon-delete" rev="2" href="javascript:" >
                                <i class="mdi mdi-trash-can-outline"></i>
                            </a>
                        </td>
                    </tr>
                ...
                <td colspan="5">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="#&amp;action=create">Add Calendar</a>
                        </div>
                    </div>
                </td>
            </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete this calendar?</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <p>All calendar details will be deleted.</p>
            </div>
...
<div class="modal fade" id="dialogDeleteSelected" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete selected calendars?</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <p>Delete all selected calendars?</p>
            </div>
            <div class="modal-footer">
