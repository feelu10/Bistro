...
<!-- Navbar end-->
    ...
    <div class="row">
        <div class="col-12 mt-3">
            <div class="card animate__animated animate__bounceInRight">
                <div class="card-body">
                    <form id="statistic-frm-id" class="frm-class" action="" method="post" name="filter_statistic">
                        <div class="row">
                            <div class="col-lg-6">
                                <label class="control-label" for="booking_range">Booking range:</label>
                                <div class="input-group">
                                    <input date-format="DD.MM.YYYY" type="text" class="form-control form-control-light" id="reservationtime" name="date_range" value="">
            ...
            <div class="card">
                <div class="card-header">
                    Sales Statistics                </div>
                <div class="card-body">
                    <div dir="ltr">
                        <div id="bar-chart" class="apex-charts mt-3" style="height: 400px"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="month-chart" style="display: none;" data-y="2022-06-01" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="2022-07-01" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="2022-08-01" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="2022-09-01" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="2022-10-01" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="2022-11-01" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="2022-12-01" data-a="1820"></div>
    <div class="month-chart" style="display: none;" data-y="2023-01-01" data-a="1520"></div>
    <div class="month-chart" style="display: none;" data-y="2023-02-01" data-a="2130"></div>
    <div class="month-chart" style="display: none;" data-y="2023-03-01" data-a="1410"></div>
    <div class="month-chart" style="display: none;" data-y="2023-04-01" data-a="850"></div>
    <div class="month-chart" style="display: none;" data-y="2023-05-01" data-a="1690"></div>
                    </div>
                </div>
                 <!-- Footer-->
                 <footer class="footer">
