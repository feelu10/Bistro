...
<div class="gz-cal-head-row">
    <div class="float_right summary-nav">
        <a href="#" class="gz-summary-link-month action-icon" rel="01-4-2023-1"> <i class="mdi mdi-arrow-left-drop-circle-outline"></i> </a>  
        <a href="#" class="gz-summary-link-month action-icon" rel="01-6-2023-1"> <i class="mdi mdi-arrow-right-drop-circle-outline"></i> </a>
    </div>
</div>
