...
$dsn = 'mysql:host=localhost;dbname=bistro';
$username = 'root';
$password = '';
...
if (isset($_POST['submit'])){
    ...
    if($user_password == $user_repassword){
        ...
        if ($count > 0) {
            ...
            window.location="../admin/adduser.php"
            </script>';
            exit;
        }

        $stmt = $pdo->prepare("INSERT INTO users (firstname, lastname, user_email, contact_no, user_password, is_active) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->execute([$firstname, $lastname, $user_email, $contact_no, $user_password, $is_active]);
    ...
    // $sql = "INSERT INTO `users`(`firstname`, `lastname`, `user_email`, `contact_no`, `user_password` ) 
    // VALUES ('$firstname', '$lastname', '$user_email','$contact_no', '$user_password')";

    // $stmt = $pdo-> prepare ("INSERT INTO users (is_active) VALUES (?)");
...
<!-- Navbar end-->    
 ...
 <form id="create-user-frm-id" class="frm-class booking-frm-class mt-3" action="" method="post" name="create" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input data-rule-required="true" id="user_email" class="form-control input-sm" type="text" name="user_email" size="25" value="" title="Email" placeholder="Email">
                            </div>
                            <div class="mb-3">
                                <label class="control-label" for="firstname">First name:</label>
                                <input data-rule-required="true" id="firstname" class="form-control input-sm" type="text" name="firstname" size="25" value="" title="First name" placeholder="First name">
                            </div>
                            <div class="mb-3">
                                <label class="control-label" for="lastname">Last name:</label>
                                <input data-rule-required="true" id="lastname" class="form-control input-sm" type="text" name="lastname" size="25" value="" title="Last name" placeholder="Last name">
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="contact_no" class="form-control input-sm" type="text" name="contact_no" size="25" value="" title="Phone" placeholder="Phone">
                            </div>
                            <div class="mb-3">
                                <label class="control-label" for="type">Status:</label>
                                <select data-rule-required="true" name="is_active" id="is_active" class="form-control input-sm medium" >
                                    <option value="">---</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input data-rule-required="true" id="user_password" class="form-control input-sm" type="password" name="user_password" size="25" value="" title="Password" placeholder="Password">
                            </div>

                            <div class="mb-3">
                                <label class="control-label" for="user_repassword">Confirm password:</label>
                                <input data-rule-required="true" id="user_repassword" class="form-control input-sm" type="password" name="user_repassword" size="25" value="" title="Re-enter Password" placeholder="Re-enter Password">
                            </div>
