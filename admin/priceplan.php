...
<!-- Navbar end-->
    ...
    Select Price Type from button `Price Type` bellow and create price plan for selected calendar.</div>
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Price Plan                    <a href="javascript:" class="btn btn-primary btn-sm ms-3" id="add-price-btn-modal">Add Price Plan</a>
                </h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card animate__animated animate__bounceInRight">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <form method="post" name="filter-price-frm" id="filter-price-frm-id">
                                <input id="calendar-filter-id" type="hidden" name="calendar_id" value="1" />
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete this price plan?</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <p>Price plan details will be deleted.</p>
            </div>
...
<div class="modal fade" id="dialogAddPricePlan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">Add Price Plan</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
</div>

<div class="modal-footer">
    <a href="javascript:" id="add-price-btn-id" data-id="" class="btn btn-success">Save</a>
    <a href="javascript:" class="btn btn-default" data-bs-dismiss="modal" aria-hidden="true">Cancel</a>
</div>        </div>
    </div>
</div>
<div class="modal fade" id="dialogEditPricePlan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Price Plan</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
        </div>
        <div class="modal-body">
            <form name="edit_price_plan" id="edit_price_plan_id" method="post" action=""> 
                <input type="hidden" id="hidden_calendar_id" name="calendar_id" value="" />
                <input type="hidden" name="from_date" id="edit_from_date" value="01.01.1970" />
                <input type="hidden" name="to_date" id="edit_to_date" value="01.01.1970" />
                <input type="hidden" name="id" value="" id="edit_price_plan_id" />
                <input type="hidden" name="calendar_id" value="" id="edit_calendar_id"/>
                <div class="mb-3">
                    ...
                    <div class="input-group flex-nowrap">
                        ...
                        <input date-format="DD.MM.YYYY" data-rule-required="true" id="edit-daterange-btn" name="date_range" class="form-control" type="text" value="01.01.1970 - 01.01.1970">
                    </div>
                </div>
        ...
        <div class="modal-footer">
            <a href="javascript:" id="еdit-price-btn-id" data-id="" class="btn btn-success">Save</a>
            <a href="javascript:" class="btn btn-default" data-bs-dismiss="modal" aria-hidden="true">Cancel</a>
        </div>
    </div>
</div></div>                    </div>
