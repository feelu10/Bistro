...
<!-- Navbar end-->
    ...
    <div class="month-chart" style="display: none;" data-y="Jun" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="Jul" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="Aug" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="Sep" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="Oct" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="Nov" data-a="0"></div>
    <div class="month-chart" style="display: none;" data-y="Dec" data-a="2"></div>
    <div class="month-chart" style="display: none;" data-y="Jan" data-a="2"></div>
    <div class="month-chart" style="display: none;" data-y="Feb" data-a="3"></div>
    <div class="month-chart" style="display: none;" data-y="Mar" data-a="1"></div>
    <div class="month-chart" style="display: none;" data-y="Apr" data-a="1"></div>
    <div class="month-chart" style="display: none;" data-y="May" data-a="1"></div>
                    </div>
                </div>
                  <!-- Footer-->
                  <footer class="footer">
