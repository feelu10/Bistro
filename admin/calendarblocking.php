    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Calendar Blocking                    <a href="javascript:" class="btn btn-primary btn-sm ms-3" id="add-block-btn-modal">Add New</a>
                </h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card animate__animated animate__bounceInRight">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <form method="post" name="filter-block-frm" id="filter-block-frm-id">
                                <input id="calendar-filter-id" type="hidden" name="calendar_id" value="" />
                                <div class="btn-group mb-2">
                                    <button type="button" class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        -- All Calendars --
                                    </button>
                                    <div class="dropdown-menu" style="">
                                        <a class="dropdown-item filter-calendar" href="javascript:" data-id="">-- All Calendars --</a>
                                                                                    <a class="dropdown-item filter-calendar" href="javascript:" data-id="1">
                                                <div>
                                                    Tables                                                </div>
                                            </a>
                                                                                        <a class="dropdown-item filter-calendar" href="javascript:" data-id="2">
                                                <div>
                                                    Private Room                                                </div>
                                            </a>
                                                                                </div>
                            ...
                            <form name="block-plan" id="block-plan-id" action="#action=deleteSelected" method="post">
                                <div class="table-responsive">
    <table id="gz-abc-table-blocking-id" class="table dt-responsive nowrap w-100 dataTable" cellpadding="0" cellspacing="0" >
        ...
        <tbody>
                                <tr  class="odd">
                        <td>
                            <input class="simple mark" type="checkbox" name="mark[]"  id="mark-2" value="2"/>
                        </td>
                        <td><span style="display: none;">1682899200</span>01.05.2023</td>
                        <td><span style="display: none;">1685664000</span>02.06.2023</td>
                        <td>Tables</td>
                        <td>
                            <a class="action-icon icon-edit" href="#" rev="2" rel="1">
                                <i class="mdi mdi-lead-pencil"></i>
                            </a>
                            <a class="action-icon icon-delete" rev="2" href="#">
                ...
                <td colspan="5">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" id="delete-selected-id" href="javascript:">Delete Selected</a>
                            <a class="dropdown-item" href="javascript:" id="add-blocking-btn-id">Add blocking</a>
                        </div>
                    </div>
                </td>
            </tr>
...
<div class="modal fade" id="dialogDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete Calendar Block</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <p>Delete this calendar block?</p>
            </div>
            <div class="modal-footer">
                <a href="javascript:" id="delete-btn-id" data-id="" class="btn btn-danger">delete</a>
                <a href="javascript:" class="btn btn-default" data-bs-dismiss="modal" aria-hidden="true">Cancel</a>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="dialogDeleteSelected" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete selected calendar blocks?</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <p>Delete all selected calendar blocks?</p>
            </div>
            <div class="modal-footer">
                <a href="javascript:" id="delete-selected-btn-id" data-id="" class="btn btn-danger">delete</a>
                <a href="javascript:" class="btn btn-default" data-bs-dismiss="modal" aria-hidden="true">Cancel</a>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="dialogAddBlock" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add blocking</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <form name="add_blockingt" id="add-block-frm-id" method="post" action=""> 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input date-format="DD.MM.YYYY" data-rule-required="true" id="daterange-btn" name="date_range" class="form-control" type="text" value="">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label>Select calendars</label>
                        <select data-rule-required="true" class="form-control" name="calendar_id" id="calendar_id">
                            <option>---</option>
            ...
            <div class="modal-footer">
                <a href="javascript:" id="add-btn-id" data-id="" class="btn btn-success">Save</a>
                <a href="javascript:" class="btn btn-default" data-bs-dismiss="modal" aria-hidden="true">Cancel</a>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="dialogEditBlock" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
