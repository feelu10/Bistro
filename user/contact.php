                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>thebistroalley@gmail.com</p>
                            </div>
                            <div class="col-md-4">
                                <h5 class="section-title ff-secondary fw-normal text-start text-primary">Technical</h5>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>tech_bistro@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        <iframe class="position-relative rounded w-100 h-100"
                            src="https://maps.google.com/maps?q=Unit F, Eastwalk Commercial Center, Brgy Moras Dela Paz, Sto Tomas Pampanga, San Fernando, Philippines&t=&z=10&ie=UTF8&iwloc=&output=embed"
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <form method="POST" action="../user/controller/process.php">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea name="message" required class="form-control" placeholder="Leave a message here" id="message" style="height: 150px"></textarea>
