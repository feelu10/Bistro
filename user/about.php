                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="img/bistro admin.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-85 wow zoomIn" data-wow-delay="0.3s" src="img/Bistro1.jpg" style="margin-top: 28%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-85 wow zoomIn" data-wow-delay="0.5s" src="img/bistro3.jpg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.7s" src="img/bistro_bg.jpg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">About Us</h5>
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>Bistro Alley</h1>
                        <p class="mb-4">Our objective at Bistro Alley is to provide a welcoming and entertaining atmosphere for all who visit. 
                            We strive to offer a wide selection of drinks, including unique and innovative cocktails, as well as classic 
                            favorites. Our goal is to create a space where friends can gather to enjoy good drinks, good company, and good times. </p>
                        <p class="mb-4"></p>
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                                    <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">72</h1>
                                    <div class="ps-4">
